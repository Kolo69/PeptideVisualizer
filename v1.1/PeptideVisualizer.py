...
N_write_threads = 2 # Nima bistvenega vpliva
...
DEBUG_txt.append(f'NOTICE: SVG_OUTPUT = {SVG_OUTPUT}, OUTPUT_EXTENTION = "{OUTPUT_EXTENTION}"')
if NOTICE:
    print(DEBUG_txt[-1])
...
HTML_CODE += '''
		...
		<div id="content"><br>'''+"Experiment \""+usr_name+"\"<br>LFQ intensities used? "+str(use_LFQ)+"<br>Relative threshold: "+str((peptide_threshold * 100))+"%<br>"+groups_summary+'<br><img src="'+exp_name+'/legend'+OUTPUT_EXTENTION+'"><br><br>DEBUG TXT<br>'+'<br>'.join(DEBUG_txt)+'''</div>
	</body>
</html>
'''
